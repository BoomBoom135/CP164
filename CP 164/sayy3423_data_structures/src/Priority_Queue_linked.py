...
class Priority_Queue:
    ...
    def insert(self, value):
        ...
        if self._front is None:
            ...
            if previous is None:
                self._front = _PQ_Node(value, current)
            else:
                previous._next = _PQ_Node(value, current)  # type: ignore
                if current is None:
    ...
    def peek(self):
        ...
        # Your code here
        value = deepcopy(self._front._value)  # type: ignore
    ...
    def split_key(self, key):
        ...
        target2 = Priority_Queue()
        while self._count > 0:
            if self._front._value < key:  # type: ignore
                target1._move_front_to_rear(self)
            else:
                target2._move_front_to_rear(self)
        if self._count == 0:
    ...
    def _append_queue(self, source):
        ...
        if self._front is None:
            ...
            self._rear._next = source._front  # type: ignore
            self._rear = source._rear
        source._front = None
        source._rear = None
